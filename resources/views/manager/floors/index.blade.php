...
@section('content')
    ...
    <section class="content">
        ...
        <!-- New admin Modal -->
        <div class="modal fade" id="newFloorModal" data-datatable="#ManagersFloorsDatatable" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content" style="border-radius: 4px">
                    <div class="modal-body" style="padding:0">
                        ...
                        <!-- /.box-header -->
                            <!-- form start -->
                            <form action="{{ route('manager.floors.store') }}" data-datatable="#ManagersFloorsDatatable" id="newFloorForm"
    ...
    <!-- Edit floor Modal -->
    <div class="modal fade" id="editFloorModal" data-datatable="#ManagersFloorsDatatable" tabindex="-1" role="dialog"
             aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content" style="border-radius: 4px">
                    <div class="modal-body" style="padding:0">
                        <div class="box box-info">
                            ...
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form action="" data-datatable="#ManagersFloorsDatatable" id="editFloorForm"
                                  style="padding: 5px 10px 30px">
                                <div class="box-body">
...
@section('scriptLinks')
    ...
    <script src="{{ url('js/managerFloors.js') }}"></script>
@endsection
