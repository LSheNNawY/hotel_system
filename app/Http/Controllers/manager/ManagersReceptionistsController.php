...
use App\DataTables\ManagersReceptionstsDatatable;
use App\Models\User;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;

class ManagersReceptionistsController extends Controller
{
    public function index(ManagersReceptionstsDatatable $dataTable)
    {
        return $dataTable->render('manager.receptionists.index', ['title' => 'Receptionists']);
    }
